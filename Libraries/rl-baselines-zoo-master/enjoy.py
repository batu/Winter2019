...
save_path = "/home/batu/Desktop/Winter_2019/Compartments/GameplayData/Qbert"
ram_save_path = "/home/batu/Desktop/Winter_2019/Compartments/GameplayData/Qbert"
...
def main():
    ...
    for _ in range(args.n_timesteps):
        ...
        screen = env.unwrapped.envs[0].unwrapped._get_image()
        ram = env.unwrapped.envs[0].unwrapped._get_ram()
        rams.append(ram)
        count = len([f for f in os.listdir(save_path + "/Screen/Pixels")])
        new_im = Image.fromarray(screen)
        new_im.save(f"{save_path}/Screen/Pixels/{count}.png")
    ...
    rams = np.array(rams)
    print(rams.shape)
    np.save(f"{save_path}/Ram/Beamrider_RAMs.npy", rams)
